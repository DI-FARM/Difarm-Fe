...
const AddSupplierModal = ({ isOpen, onClose, handleRefetch }: any) => {
    const { createSupplier, loading, error } = useSuppliers();
                        ...
                        >
                            <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-xl my-8 text-black dark:text-white-dark">
                                <div className="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                                    <div className="font-bold text-lg">Add Supplier</div>
                                </div>
                                <div className="p-5">
                                    {error && (
